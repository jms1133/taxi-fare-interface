let taxiFareApiUrl = 'https://taxifare.lewagon.ai/predict'; // replace with your API endpoint 'https://localhost:8001/predict'
...
mapboxgl.accessToken = 'pk.eyJ1Ijoiam1zMTEzMyIsImEiOiJjbGllY3NvdmkwaWMyM2VzMGJyYzNjb2s2In0.ZD3UF-Hm1ffZMZ7GXIPVrQ;'
